...
extension UIBarButtonItem {
    /// Creates a `UIBarButtonItem` with JKit styling that contains a label.
    /// - Parameters:
    ///   - theme: The theme used for styling of the item.
    ///   - text: The text to display on the label.
    /// - Returns: A JKit-styled `UIBarButtonItem` with a label.
    ...
    /// Creates a `UIBarButtonItem` with JKit styling that contains an image.
    /// - Parameters:
    ///   - theme: The theme used for styling of the item.
    ...
    /// - Returns: A JKit-styled `UIBarButtonItem` with an image.
